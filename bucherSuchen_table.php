...
?>
    ...
    <div class="container">
        ...
        <form method="GET" action="bucherSuchen_table.php">

            <!--Suchleiste-->
            <div class="input-group mb-3">
                <select class="form-select" name="search_column" style="max-width: 150px;">
                    <option value="kurztitle" <?php if ($search_column == 'kurztitle') echo 'selected'; ?>>Titel
                    </option>
                    ...
                    <option value="kategorie" <?php if ($search_column == 'kategorie') echo 'selected'; ?>>Kategorie
                    </option>
            ...
            <div class="input-group mb-3">
                ...
                <select class="form-select" id="sort_column" name="sort_column">
                    <option value="kurztitle" <?php if ($sortier_collumns == 'kurztitle') echo 'selected'; ?>>Titel
                    </option>
                    <option value="autor" <?php if ($sortier_collumns == 'autor') echo 'selected'; ?>>Autor</option>
                    <option value="katalog" <?php if ($sortier_collumns == 'katalog') echo 'selected'; ?>>Katalog
                    </option>
                    <option value="kategorie" <?php if ($sortier_collumns == 'kategorie') echo 'selected'; ?>>
                        Kategorie
                    </option>
